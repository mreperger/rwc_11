...
<?php
	...
	if(isset($_POST["btn_actualizar"])){
		if($_POST["puntos_equipo_locatario"] != "" && $_POST["tries_equipo_locatario"] != "" && $_POST["puntos_equipo_visitante"] != "" && $_POST["tries_equipo_visitante"] != ""){
			$sql_update = "UPDATE partidos SET puntos_equipo_locatario = ".$_POST["puntos_equipo_locatario"].", tries_equipo_locatario = ".$_POST["tries_equipo_locatario"].",
				puntos_equipo_visitante =".$_POST["puntos_equipo_visitante"].", tries_equipo_visitante = ".$_POST["tries_equipo_visitante"].", estado_partido = ".$_POST["estado_partido"]." WHERE id =".$_REQUEST["id"]."";

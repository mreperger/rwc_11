		...
		<form name="frm_actualizar" action="actualizar_resultado.php?id=<?php echo $_REQUEST["id"];?>" method="post">
			<table>
				...
				<tr>
					...
					<td align="center"><input type="text" name="puntos_equipo_locatario"></td>
					<td align="center"><input type="text" name="tries_equipo_locatario"></td>
					<td>vs</td>
					<td align="center"><input type="text" name="tries_equipo_visitante"></td>
					<td align="center"><input type="text" name="puntos_equipo_visitante"></td>
